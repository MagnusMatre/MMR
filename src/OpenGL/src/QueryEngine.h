...
public:
	...
	std::unordered_map<int, float> m_scalar_weights = {
		...
		{SCALAR_FEATURES::VOLUMECOMPS,				0.0f}, // Don't use this ever
		{SCALAR_FEATURES::CONVEXITY,				1.0f},
		{SCALAR_FEATURES::ECCENTRICITY02,			2.0f},
		...
		{SCALAR_FEATURES::CUBEROOTVOLUME,			0.0f},
		{SCALAR_FEATURES::SQUAREROOTAREA,			1.0f},
		{SCALAR_FEATURES::DIAMETERTOCUBEROOTVOLUME,	0.0f}, // Don't use this ever
		{SCALAR_FEATURES::DIAMETERTOSQUAREROOTAREA,	0.0f},
		{SCALAR_FEATURES::DIAMETERSQUARED,			0.0f}, // Don't use this ever
		{SCALAR_FEATURES::BBCUBEROOTVOLUME,			1.0f},
		{SCALAR_FEATURES::RECTANGULARITY,			2.0f}
	};
...
private:
	...
	float getScalarWeightsSum();
	float getHistogramWeightsSum();
};
