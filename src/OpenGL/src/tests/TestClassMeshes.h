...
namespace test {
	...
	private:
		...
		std::string m_okayDirectory;
		std::string m_normalflipDirectory;
		std::string m_smallchangeDirectory;
		std::string m_hopelessDirectory; // Path to save the messy meshes to
